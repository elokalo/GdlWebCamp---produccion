  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>puedes editar los datos de una categoría</small>
      </h1>
    </section>
              ...
              <form role="form" method="POST" name="guardar-registro" id="guardar-registro" action="modelo-categoria.php">
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="categoria" name="categoria" placeholder="Categoría" value="<?php echo $categoria['cat_evento']; ?>">
                    </div>
                    <div class="form-group">
