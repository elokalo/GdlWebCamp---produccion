    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="lista-eventos.php"><i class="fas fa-list-ul"></i>Ver Todos</a></li>
            <li><a href="crear-eventos.php"><i class="fas fa-plus-circle"></i>Agregar</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fas fa-book"></i> <span>Categoría Eventos</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="crear-categorias.php"><i class="fas fa-plus-circle"></i>Agregar</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fas fa-users"></i> <span>Invitados</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li><a href="crear-invitados.php"><i class="fas fa-plus-circle"></i>Agregar</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="crear-registros.php"><i class="fas fa-plus-circle"></i>Agregar</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fas fa-comments"></i></i> <span>Testimoniales</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
