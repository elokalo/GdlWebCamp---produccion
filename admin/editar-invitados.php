              ...
              <form role="form" method="POST" name="guardar-registro" id="guardar-registro-archivo" action="modelo-invitado.php" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="descripcion" id="descripcion" rows="8" placeholder="Biografía"><?php echo $invitado['descripcion']; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="imagen_actual">Imágen Actual</label>
                        <br>
