      ...
      <form id="registro" class="registro" action="pagar.php" method="POST">
          ...
          <div id="eventos" class="eventos clearfix">
              ...
              <?php 
                ...
                //Debemos ordenar nuestros datos en un arreglo multidimensional y asociativo para poder acceder en el orden que deseamos a los datos, en este caso deseamos primero que esten ordenados por dia viernes, sabado y domingo, el nombre del evento y la categoria que esta tendra ya sea seminario, taller o conferencia
                $eventos_dias = array();
